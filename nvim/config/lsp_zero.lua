...
local config_jdtls = {
    ...
    cmd = {
        ...
        "-configuration",
        "/home/anshai/.local/share/nvim/mason/packages/jdtls/config_linux",
...
lsp.configure('tsserver', { on_attach = on_attach })
lsp.configure('jdtls', { on_attach = on_attach_jdt_ls })
lsp.configure('pyright', { on_attach = on_attach })
